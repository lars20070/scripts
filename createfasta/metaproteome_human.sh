...
# download UniProt human reference proteome
...
wget "ftp://ftp.uniprot.org/pub/databases/uniprot/knowledgebase/reference_proteomes/Eukaryota/UP000005640/UP000005640_9606.fasta.gz" -O uniprot_reference_Human.fasta.gz
gzip -d uniprot_reference_Human.fasta.gz

# download UniProt additional human reference proteome
...
wget "ftp://ftp.uniprot.org/pub/databases/uniprot/knowledgebase/reference_proteomes/Eukaryota/UP000005640/UP000005640_9606_additional.fasta.gz" -O uniprot_reference_Human_additional.fasta.gz
gzip -d uniprot_reference_Human_additional.fasta.gz
...
# combine all sources
cat uniprot_reference_Human.fasta uniprot_reference_Archaea.fasta uniprot_reference_Bacteria.fasta uniprot_reference_Fungi.fasta uniprot_reference_Viruses.fasta contaminants_crap.fasta contaminants_maxquant.fasta > combined_uniprot_reference_only.fasta
